...
const solutions = [solve1A(), solve1B(), solve2A(), solve2B(), solve3A(), solve3B()];
const testSolutions = [testSolve1A(), testSolve1B(), testSolve2A(), testSolve2B(), testSolve3A(), testSolve3B()];
